...
public class InterfaceProdutoRestaurante {
    ...
    public void menu(Restaurante restauranteLogado) {
        ...
        while (rodando) {
            ...
            System.out.printf ("│  Restaurante: %-17s│%n", restauranteLogado.getNome());
            System.out.println("├──────────────────────────────────┤");
            System.out.println("│                                  │");
    ...
    public void criarProduto(Restaurante restauranteLogado) {
        Loading.LimparTerminal("Abrindo cadastro...");
        ...
        System.out.print("\n  > Nome: ");
        p.setNome(Input.lerTexto("Nome"));

        System.out.print("  > Descrição: ");
        p.setDescricao(Input.lerTexto("Descrição"));

        p.setPreco(Input.lerDouble("  > Preço: R$ "));

        System.out.print("  > Categoria: ");
        p.setCategoria(Input.lerTexto("Categoria"));

        p.setIdRestaurante(restauranteLogado.getId());

        Loading.LimparTerminal("Salvando produto...");
        ...
        System.out.println("├──────────────────────────────────┤");
        System.out.printf ("│  Nome:      %-21s│%n", p.getNome());
        System.out.printf ("│  Descrição: %-21s│%n", p.getDescricao());
        System.out.printf ("│  Preço:     R$%-19.2f│%n", p.getPreco());
        System.out.printf ("│  Categoria: %-21s│%n", p.getCategoria());
        System.out.println("└──────────────────────────────────┘");
        System.out.println("\n  [ENTER] Continuar...");
    ...
    public void listarProdutos(Restaurante restauranteLogado) {
        Loading.LimparTerminal("Carregando produtos...");
        ...
        if (produtos.isEmpty()) {
            ...
            for (Produto p : produtos) {
                System.out.printf("│  ID:        %-21s│%n", "#" + p.getId());
                System.out.printf("│  Nome:      %-21s│%n", p.getNome());
                System.out.printf("│  Descrição: %-21s│%n", p.getDescricao());
                System.out.printf("│  Categoria: %-21s│%n", p.getCategoria());
                System.out.printf("│  Preço:     R$%-19.2f│%n", p.getPreco());
    ...
    public void deletarProduto(Restaurante restauranteLogado) {
        ...
        Loading.LimparTerminal("Removendo produto...");

        System.out.println("┌──────────────────────────────────┐");
        System.out.println("│        PRODUTO REMOVIDO!         │");
        System.out.printf ("│  Produto #%04d deletado.         │%n", idProduto);
        System.out.println("└──────────────────────────────────┘");
        System.out.println("\n  [ENTER] Continuar...");
        Input.scanner.nextLine();
    }
